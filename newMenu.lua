...
function menu()
    ...
    echo ("<RECTANGLE NAME=1 X=40 Y=90 WIDTH=200 HEIGHT=40 VISIBLE=0>")
    echo ("<RECTANGLE NAME=2 X=40 Y=155 WIDTH=200 HEIGHT=40 VISIBLE=0>")
    echo ("<RECTANGLE NAME=3 X=40 Y=215 WIDTH=200 HEIGHT=40 VISIBLE=0>")
    echo ("<RECTANGLE NAME=4 X=40 Y=265 WIDTH=200 HEIGHT=40 VISIBLE=0>")
    echo ("<RECTANGLE NAME=5 X=40 Y=335 WIDTH=200 HEIGHT=40 VISIBLE=0>")
    echo ("<RECTANGLE NAME=6 X=40 Y=395 WIDTH=200 HEIGHT=40 VISIBLE=0>")
...
function escolheOpc()
    ...
    if get.MENU == "1" then
        ...
        echo ("<GET TYPE=FIELD NAME=MESA SIZE=3 COL=18 LIN=16 NOENTER=0>")
...
function consultarPedido()
    ...
    echo ("<RECTANGLE NAME=1 X=40 Y=365 WIDTH=230 HEIGHT=60 VISIBLE=0>")
...
function Menprods()
    ...
    echo ("<RECTANGLE NAME=1 X=35 Y=74 WIDTH=240 HEIGHT=50 VISIBLE=0>")
    echo ("<RECTANGLE NAME=2 X=35 Y=148 WIDTH=240 HEIGHT=50 VISIBLE=0>")
    echo ("<RECTANGLE NAME=3 X=35 Y=224 WIDTH=240 HEIGHT=50 VISIBLE=0>")
    echo ("<RECTANGLE NAME=4 X=35 Y=304 WIDTH=240 HEIGHT=50 VISIBLE=0>")
    echo ("<RECTANGLE NAME=5 X=35 Y=378 WIDTH=240 HEIGHT=50 VISIBLE=0>")
...
function prods()
    ...
    if get.OPC == "1" then
        ...
        echo ("<RECTANGLE NAME=1 X=60 Y=117 WIDTH=170 HEIGHT=40 VISIBLE=0>")
        echo ("<RECTANGLE NAME=2 X=60 Y=185 WIDTH=170 HEIGHT=40 VISIBLE=0>")
        echo ("<RECTANGLE NAME=3 X=60 Y=244 WIDTH=170 HEIGHT=40 VISIBLE=0>")
        echo ("<RECTANGLE NAME=4 X=60 Y=304 WIDTH=170 HEIGHT=40 VISIBLE=0>")
        echo ("<RECTANGLE NAME=5V X=60 Y=370 WIDTH=170 HEIGHT=40 VISIBLE=0>")
    ...
    if get.OPC == "2" then
        ...
        echo ("<RECTANGLE NAME=5 X=60 Y=117 WIDTH=170 HEIGHT=40 VISIBLE=0>")
        echo ("<RECTANGLE NAME=6 X=60 Y=185 WIDTH=170 HEIGHT=40 VISIBLE=0>")
        echo ("<RECTANGLE NAME=7 X=60 Y=250 WIDTH=170 HEIGHT=40 VISIBLE=0>")
        echo ("<RECTANGLE NAME=5V X=60 Y=314 WIDTH=170 HEIGHT=40 VISIBLE=0>")
...
function setProd()
    ...
    if get.OPC == "1" then
        ...
        echo ("<GET TYPE=FIELD NAME=QTD SIZE=2 COL=18 LIN=16 NOENTER=0>")
    ...
    if get.OPC == "2" then
        ...
        echo ("<RECTANGLE NAME=1 X=42 Y=120 WIDTH=200 HEIGHT=40 VISIBLE=0>")
        echo ("<RECTANGLE NAME=2 X=42 Y=180 WIDTH=200 HEIGHT=40 VISIBLE=0>")
        echo ("<RECTANGLE NAME=3 X=42 Y=242 WIDTH=200 HEIGHT=40 VISIBLE=0>")
        echo ("<RECTANGLE NAME=4 X=42 Y=303 WIDTH=200 HEIGHT=40 VISIBLE=0>")
        echo ("<RECTANGLE NAME=5 X=42 Y=363 WIDTH=200 HEIGHT=40 VISIBLE=0>")
...
function opcRefri()
    ...
    if get.REFRI == "1" then
        ...
        echo ("<RECTANGLE NAME=1 X=40 Y=215 WIDTH=240 HEIGHT=50 VISIBLE=0>")
        echo ("<RECTANGLE NAME=2 X=40 Y=295 WIDTH=240 HEIGHT=50 VISIBLE=0>")
...
function volRefri()
    ...
    if get.OPC == "1" then
        ...
        echo ("<GET TYPE=FIELD NAME=QTD SIZE=QTD COL=18 LIN=16 NOENTER=1>")
